...
object BracelessSyntax {
  ...
  // scala 3 one-liner
  // val anIfExpression_v6 = if 2 > 3 then "bugger" else "smaller"
  ...
  // : is the end token - compiler expects the body of Animal
  //  class Animal:
  //    def eat(): Unit =
  //      println("I'm eating")
  //    end eat
  ...
  //
  //  // Significant indentation = strictly larger indentation
